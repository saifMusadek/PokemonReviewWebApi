                ...
                var pokemonOwners = new List<PokemonOwner>()
                {
                    new PokemonOwner()
                    {
                        Pokemon = new Pokemon()
                        {
                            ...
                            {
                                new PokemonCatagory { Catagory = new Catagory() { Name = "Electric"}}
                            },
                    ...
                    new PokemonOwner()
                    {
                        Pokemon = new Pokemon()
                        {
                            ...
                            PokemonCatagories = new List<PokemonCatagory>()
                            {
                                new PokemonCatagory { Catagory = new Catagory() { Name = "Water"}}
                            },
                            Reviews = new List<Review>()
                            {
                                    ...
                                    new PokemonOwner()
                    {
                        Pokemon = new Pokemon()
                        {
                            ...
                            PokemonCatagories = new List<PokemonCatagory>()
                            {
                                new PokemonCatagory { Catagory = new Catagory() { Name = "Leaf"}}
                            },
                            Reviews = new List<Review>()
                            {
